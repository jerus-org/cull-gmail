...
- deps: update rust crate thiserror to 2.0.20(pr [#222])
- deps: update dependency toolkit to v7(pr [#224])
- deps: lock file maintenance(pr [#225])
- deps: lock file maintenance(pr [#234])
- deps: update rust crate clap to 4.6.7(pr [#226])
- deps: update rust crate config to 0.15.26(pr [#227])
- deps: update rust crate flate2 to 1.1.10(pr [#228])
- deps: update rust crate hyper-rustls to 0.27.10(pr [#229])
...
- deps: lock file maintenance(pr [#205])
- deps: update rust crate clap to 4.6.4(pr [#206])
- deps: update rust crate futures to 0.3.33(pr [#207])
- deps: update rust crate indicatif to 0.18.6(pr [#208])
- deps: update rust crate thiserror to 2.0.19(pr [#209])
- deps: update rust crate toml to 1.1.3(pr [#210])
- deps: update serde packages(pr [#211])
- deps: update rust crate base64 to 0.23.0(pr [#213])
- deps: update rust crate tokio to 1.53.1(pr [#214])
...
- deps: update dependency toolkit to v6.4.2(pr [#193])
...
- deps: update rust crate config to 0.15.25(pr [#197])
- deps: update rust crate log to 0.4.33(pr [#198])
- deps: update rust crate serde_json to 1.0.150(pr [#199])
- deps: update rust crate tokio to 1.52.3(pr [#200])
- deps: update rust crate env_logger to 0.11.11(pr [#202])
- deps: update rust crate indicatif to 0.18.5(pr [#203])
...
[#185]: https://github.com/jerus-org/cull-gmail/pull/185
...
[#197]: https://github.com/jerus-org/cull-gmail/pull/197
[#198]: https://github.com/jerus-org/cull-gmail/pull/198
[#199]: https://github.com/jerus-org/cull-gmail/pull/199
...
[#212]: https://github.com/jerus-org/cull-gmail/pull/212
...
[#208]: https://github.com/jerus-org/cull-gmail/pull/208
[#209]: https://github.com/jerus-org/cull-gmail/pull/209
[#210]: https://github.com/jerus-org/cull-gmail/pull/210
...
[#222]: https://github.com/jerus-org/cull-gmail/pull/222
[#224]: https://github.com/jerus-org/cull-gmail/pull/224
[#225]: https://github.com/jerus-org/cull-gmail/pull/225
[#234]: https://github.com/jerus-org/cull-gmail/pull/234
[#226]: https://github.com/jerus-org/cull-gmail/pull/226
[#227]: https://github.com/jerus-org/cull-gmail/pull/227
[#228]: https://github.com/jerus-org/cull-gmail/pull/228
[#229]: https://github.com/jerus-org/cull-gmail/pull/229
